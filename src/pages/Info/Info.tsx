      ...
      case 'privacy':
        return (
          <div>
            ...
            <p>회사는 아래의 항목에 해당하는 개인정보를 수집합니다.</p>
            <ol>
              <li>수집 항목</li>
              <ul>
                <li>이름, 이메일 주소, 성별, 나이, 국가, 주소, 결제 내역</li>
                <li>아이큐 테스트 결과 및 점수</li>
                <li>결제 내역</li>
              </ul>
              <li>수집 방법</li>
              <ul>
                <li>이용자가 테스트를 진행하거나 결제 과정에서 직접 입력한 정보</li>
                <li>결제 시 PG사로부터 수신한 결제 정보</li>
              </ul>
            </ol>
            <h3>제2조 (개인정보의 수집 및 이용 목적)</h3>
            <p>회사는 수집한 개인정보를 다음의 목적을 위하여 이용합니다.</p>
            <ol>
              <li>아이큐 테스트 결과 기반 인증서 및 보고서 작성</li>
              <li>이메일을 통한 결과 전달</li>
              <li>이용자 문의 대응 및 서비스 이용 관련 고지</li>
            </ol>
            ...
            <ul>
              <li>보존 항목: 이름, 이메일, 성별, 나이대, 국가, 점수, 결제내역</li>
              <li>보존 기간: 수집일로부터 2년 또는 이용자의 삭제 요청 시까지</li>
            </ul>
            ...
            <p>이용자는 언제든지 회사에 대해 아래 사항에 대한 권리를 행사할 수 있습니다.</p>
            <ol>
              <li>개인정보 열람 요구</li>
            ...
            <p>회사는 쿠키, 웹 로그 분석 도구(Google Analytics 등)를 사용하지 않습니다.</p>
            <h3>제8조 (개인정보의 안전성 확보 조치)</h3>
            <p>회사는 개인정보보호법 제29조에 따라 다음과 같은 안전성 확보에 필요한 조치를 하고 있습니다.</p>
            <ul>
              <li>개인정보에 대한 접근 제한</li>
              <li>문서 파일 및 전송 파일 암호화</li>
              <li>외부 접속 제어 및 보안 소프트웨어 사용</li>
            </ul>
        ...
        return (
          <div>
            ...
            <ol>
              ...
              <li>"결제"란 이용자가 회사에 일정 금액을 지불하고 유료 서비스를 이용하는 행위를 말합니다.</li>
              <li>"콘텐츠"란 회사가 서비스 내에서 제공하는 텍스트, 이미지, 보고서, 인증서 등의 결과물을 말합니다.</li>
            </ol>
            ...
            <h3>제4조 (서비스의 제공)</h3>
            <ol>
              <li>회사는 아래와 같은 서비스를 제공합니다:</li>
              <ul>
                <li>IQ 테스트 진행</li>
                <li>결과 기반 점수 제공</li>
                <li>개인화된 보고서 및 인증서 작성 및 이메일 발송</li>
              </ul>
            </ol>
            <h3>제5조 (서비스 이용요금 및 결제)</h3>
            <ol>
              <li>
            ...
            <ol>
              ...
              <ul>
                <li>타인의 정보 도용 또는 허위 입력</li>
                <li>서비스에 대한 부정 이용 시도 또는 해킹</li>
                <li>회사 및 제3자의 지식재산권 침해</li>
                <li>공공질서 및 미풍양속에 반하는 행위</li>
              </ul>
            </ol>
            <h3>제7조 (저작권 및 지식재산권)</h3>
            <ol>
              <li>
                서비스 내 제공되는 모든 콘텐츠(텍스트, 디자인, 이미지 등)에 대한 저작권 및 지식재산권은 회사에
                귀속됩니다.
              </li>
              <li>이용자는 제공된 콘텐츠를 개인적 목적 외에는 복제, 배포, 전송, 게시, 수정할 수 없습니다.</li>
            </ol>
            <h3>제8조 (면책조항)</h3>
            <ol>
              <li>회사는 이용자의 귀책사유로 발생한 문제에 대해 책임지지 않습니다.</li>
              <li>
            ...
            <h3>제10조 (고객지원 및 문의)</h3>
            <p>서비스 관련 문의는 아래 이메일로 접수받습니다.</p>
            <p>
              <strong>이메일:</strong> brainbrainsite@gmail.com
            </p>
            <h3>부칙</h3>
            <p>본 약관은 2025년 5월 11일부터 시행됩니다.</p>
          </div>
        );
      case 'business':
        return (
